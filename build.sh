...
sed -i "s/main_edit_.*.css/main_edit_$NOW.css/" ../edit.html
sed -i "s/main_pres_.*.css/main_pres_$NOW.css/" ../pres.html
sed -i "s/main_edit_.*.js/main_edit_$NOW.js/" ../edit.html
sed -i "s/main_pres_.*.js/main_pres_$NOW.js/" ../pres.html
